...
export function ConnectionManager() {
  ...
  useEffect(() => {
    ...
    const aoConnectionCheck = aoClient.addEventListener('connection', (data) => {
  ...
  const handleReconnect = async () => {
    ...
    try {
      ...
      // Force AO client to check connection
      const isAoConnected = aoClient.isGatewayConnected()
      ...
      if (isAoConnected) {
        ...
        toast({
          ...
          description: "Could not reach the game server. Please try again.",
          variant: "destructive",
        })
      }
    } catch (error) {
