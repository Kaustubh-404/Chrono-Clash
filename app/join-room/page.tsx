...
import { Loader2, ArrowRight, RefreshCw, AlertTriangle, Shield, Swords } from "lucide-react"
...
export default function JoinRoomPage() {
  ...
  const checkRoomInfo = async (code: string) => {
    ...
    try {
      const response = await aoClient.getGameStateByRoomCode(code)
...
//   // References for input fields - fixed type to match React.RefCallback
//   const inputRefs = useRef<(HTMLInputElement | null)[]>([null, null, null, null, null, null])
...
//                     <Input
//                       key={index}
//                       // Fix 1: Use callback ref pattern without returning a value
//                       ref={(el) => { inputRefs.current[index] = el }}
//                       value={char === ' ' ? '' : char}
//                       onChange={(e) => handleInputChange(e, index)}
//                       onKeyDown={(e) => handleKeyDown(e, index)}
...
//               <Button
//                 onClick={handleJoinRoom}
//                 // Fix 2: Use undefined instead of null for disabled property
//                 disabled={
//                   isJoining || 
//                   !arweaveWallet.isConnected() || 
//                   roomCode.length !== 6 || 
//                   (roomInfo !== null && roomInfo.wager > availableBalance)
//                 }
//                 className="w-full bg-cyan-600 hover:bg-cyan-700"
//               >
//                 {isJoining ? (
...
//               {roomInfo && (
//                 <div className="bg-gray-700 rounded-lg p-4 mt-4 inline-block">
//                   <div className="text-sm mb-1">Wagered Amount:</div>
//                   <div className="text-amber-400 text-xl font-mono">{roomInfo.wager.toFixed(2)} AR</div>
//                 </div>
//               )}
//             </div>
//           )}
...
// //                   !arweaveWallet.isConnected() || 
// //                   roomCode.length !== 6 || 
// //                   (roomInfo && roomInfo.wager > availableBalance)
// //                 }
// //                 className="w-full bg-cyan-600 hover:bg-cyan-700"
// //               >
// //                 {isJoining ? (
