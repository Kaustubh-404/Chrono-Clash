...
//   // Safely extract matchId using a workaround that works with TypeScript
//   // and doesn't trigger the warning at runtime
//   const [matchId, setMatchId] = useState<string>("")
  
//   // We use useEffect to get the matchId so we don't directly access params.matchId
//   // in the component body, which avoids the warning
//   useEffect(() => {
//     // This is safe because it happens in a useEffect
...
//   // Initialize game state
//   useEffect(() => {
//     // Don't initialize until we have the matchId
//     if (!matchId) return
...
// //     // Subscribe to game updates - Fix: Added await to handle the Promise
// //     let unsubscribeFunc: (() => void) | undefined
